...
export const products: Product[] = [
  {
    ...
    description: "تی‌شرت اورسایز با پارچه نخی ۱۰۰٪ درجه یک. برش آزاد و راحت برای استایل روزمره و خیابانی.",
    price: 1890000,
  ...
  },
  {
    ...
    name: "شلوار جین بگ",
    description: "شلوار جین بگ با برش گشاد و راحت. پارچه دنیم با کیفیت بالا و رنگ ثابت.",
    price: 3290000,
  ...
  },
  {
    ...
    description: "پیراهن لینن سبک و خنک با بافت طبیعی. مناسب تابستان و استایل رسمی-کژوال.",
    price: 2450000,
    category: "shirts",
    gender: "men",
    images: [
  ...
  },
  {
    ...
    slug: "crop-top-white",
    name: "کراپ تاپ سفید",
    description: "کراپ تاپ ساده و شیک با پارچه نرم. مناسب لایه‌بندی و استایل روزمره.",
    price: 890000,
  ...
  },
  {
    ...
    description: "هودی اورسایز با پنبه سنگین و کلاه بزرگ. مناسب پاییز و زمستان.",
    price: 2790000,
    category: "hoodies",
    gender: "unisex",
    images: [
  ...
  },
  {
    ...
    description: "دامن پلیسه میدی با پارچه سبک و روان. مناسب استایل رسمی و کژوال.",
    price: 2190000,
    category: "dresses",
    gender: "women",
    images: [
  ...
  },
  {
    ...
    description: "شلوار کارگو با جیب‌های کاربردی و پارچه مقاوم. مناسب استایل خیابانی.",
    price: 2590000,
  ...
  },
  {
    ...
    description: "کاردیگان بافت نرم و گرم با طراحی مینیمال. مناسب لایه‌بندی پاییزی.",
    price: 3100000,
    category: "jackets",
    gender: "women",
    images: [
  ...
  },
  {
    ...
    description: "پیراهن آکسفورد با بافت محکم و ظاهر شیک. مناسب محیط کار و استایل رسمی.",
    price: 2650000,
    category: "shirts",
    gender: "men",
    images: [
  ...
  },
  {
    ...
    description: "شلوار چینو با برش راحت و پارچه نرم. مناسب استایل کژوال و نیمه‌رسمی.",
    price: 2350000,
    category: "pants",
    gender: "men",
    images: [
  ...
  },
  {
    ...
    name: "بلوز ابریشمی",
    description: "بلوز با ترکیب ابریشم و ویسکوز. نرم، لطیف و مناسب استایل شیک.",
    price: 2890000,
  ...
  },
  {
    ...
    name: "کت جین کلاسیک",
    description: "کت جین با برش کلاسیک و پارچه دنیم با کیفیت. مناسب لایه‌بندی در تمام فصل‌ها.",
    price: 3590000,
    category: "jackets",
    gender: "unisex",
    images: [
  ...
  },
  {
    ...
    name: "تاپ ریب",
    description: "تاپ ریب با بافت ظریف و کشسانی مناسب. مناسب لایه‌بندی یا استفاده مستقل.",
    price: 790000,
    category: "t-shirts",
    gender: "women",
    images: [
  ...
  },
  {
    ...
    name: "پالتو پشمی",
    description: "پالتو با ترکیب پشم و طراحی مینیمال. گرم، شیک و مناسب زمستان.",
    price: 5890000,
  ...
  },
  {
    ...
    description: "شلوار اسلیم با پارچه کشی و ظاهر مدرن. مناسب محیط کار و استایل شهری.",
    price: 2490000,
    category: "pants",
    gender: "men",
    images: [
  ...
  },
  {
    ...
    name: "پیراهن میدی",
    description: "پیراهن میدی با طراحی ساده و شیک. پارچه سبک و روان مناسب بهار و تابستان.",
    price: 2750000,
    category: "dresses",
    gender: "women",
    images: [
  ...
  },
  {
    ...
    name: "سویشرت کرو",
    description: "سویشرت با یقه گرد و پارچه پنبه‌ای نرم. مناسب استایل روزمره.",
    price: 2190000,
    category: "hoodies",
    gender: "unisex",
    images: [
  ...
  },
  {
    ...
    description: "کمربند چرم طبیعی با سگک فلزی مینیمال. مناسب استایل رسمی و کژوال.",
    price: 1290000,
  ...
  },
  {
    ...
    description: "شلوار جین کمر بلند با برش مدرن. پارچه دنیم با کشسانی مناسب.",
    price: 2990000,
  ...
  },
  {
    ...
    description: "کیف توت با طراحی مینیمال و پارچه محکم. مناسب استفاده روزانه.",
    price: 1590000,
    category: "accessories",
    gender: "unisex",
    images: [
